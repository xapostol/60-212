...
function setup() {
  ...
  b.text("A Generative Book Using Twitter and Spooky Hashtags", 72,72,360,36);
  b.text("\n");
  b.text("Xavier Apostol, Fall 2016", 72,108,360,36);
  ...
  for (var i = 0; i < jsonData.length; i++) {
    ...
    // Create textframes for the "date" field.
    b.fill(0);
    b.textSize(36);
    ...
    // Create textframes for the "text" field.
    b.fill(255);
    b.textSize(56);
    // b.textFont("Helvetica","Bold"); 
    b.textFont("Roman SD");
    b.textAlign(Justification.CENTER_ALIGN, VerticalJustification.CENTER_ALIGN );
    b.text(jsonData[i].text, titleX,titleY,titleW,titleH);
